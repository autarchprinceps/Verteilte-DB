-- ***************************************************************
-- * File Name:                  distributed_database.ddl        *
-- * File Creator:               Knolle                          *
...
--
-- ***************************************************************
-- * Job Control Section (in Oracle SQL*Plus)
...
Insert into depot values ( 1 , 'Baumaschinen Verleih Bonn' , 'Buddestraﬂe 30', 'Bonn' , '53111' , 'Germany' );
...
Insert into customer values ( 1 , 'BB Hoch- und Tiefbau GmbH' , 'Tettaustraﬂe 1' , 'Bonn' , '53111' , 'Germany' );
Insert into customer values ( 2 , 'Canzler Bau GmbH' , 'Daasdorfer Straﬂe 38' , 'Weimar' , '99428' , 'Germany' );
Insert into customer values ( 3 , 'Etzoldt Bau GmbH Hoch- und Tiefbau' , 'Mittelstraﬂe 23' , 'Jena' , '07745' , 'Germany' );
Insert into customer values ( 4 , 'Kkd Tiefbau Weimar GmbH' , 'Dammstr. 2' , 'Apolda' , '99510' , 'Geremany' );
...
-- End Job Control Section (in Oracle SQL*Plus)
