-- ***************************************************************
-- * File Name:                  london_global_pk_database.sql   *
-- * File Creator:               Knolle                          *
...
set 	pagesize 	50
set     escape      \
spool   ./london_global_pk_database.log
...
INSERT INTO LDN_ARTICLE values (:new.ID_CUSTOMER, :new.ID_ARTICLE, :new.CONTRACT, :new.RENTFROM, :new.RENTTO, :new.RETURNFLAG);
...
DELETE FROM LDN_ARTICLE WHERE ID_ARTICLE = :old.ID_ARTICLE AND ID_CUSTOMER = :old.ID_CUSTOMER AND CONTRACT = :old.CONTRACT;
elsif cust_state = 'United States' OR cust_state = 'Canada' THEN
