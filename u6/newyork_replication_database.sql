-- ***************************************************************
-- * File Name:                  newyork_replication_database.sql*
-- * File Creator:               Knolle                          *
...
set 	pagesize 	50
set     escape      \
spool   ./newyork_replication_database.log
...
--
-- ***************************************************************
-- * Die Aenderungen fuer den Standort New York  
--
...
BEFORE INSERT OR DELETE OR update ON nyk_ARTICLE
FOR EACH ROW
BEGIN
	IF INSERTING THEN
...
BEFORE INSERT OR DELETE OR update ON nyk_rent
FOR EACH ROW
BEGIN
	IF INSERTING THEN
...
BEFORE INSERT OR DELETE OR update ON nyk_CUSTOMER
FOR EACH ROW
BEGIN
	IF INSERTING THEN
