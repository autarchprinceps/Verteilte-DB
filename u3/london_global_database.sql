-- ***************************************************************
-- * File Name:                  london_global_database.sql      *
-- * File Creator:               Knolle                          *
...
set 	pagesize 	50
set     escape      \
spool   ./london_global_database.log
...
AND RENTTO > sysdate
and id_depot = 2 -- optimize: use ldn_article ?
GROUP BY TYPE;

-- 9.  Monatsabrechnung für Customer 6
SELECT 
  a.ID_article, a.TYPE,
